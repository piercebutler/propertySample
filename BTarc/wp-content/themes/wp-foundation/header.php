			...
			<div class="twelve columns">
				<header role="banner" id="top-header">
					...
					<div class="nav-container">
                    	<div class="nav">
							<div class="bt-logo" onclick="location.href='http://localhost:8888/BTarc/';" style="cursor:pointer;"></div>
                    ...
                    <div class="top-wrapper">
                    	...
                    	<div class="five columns show-on-phones">
                        	<img class="displayed" src="http://localhost:8888/BTarc/wp-content/uploads/2012/12/501.png" alt="...">
                        </div>
                        
                        <div class="six columns show-on-phones">
                        	<h1 class="centered">Young Scientist & Technology 50th Year Exhibiton Archive</h1>
                        </div>
                        
                    	<div class="two columns hide-on-phones">
                        	<img src="http://localhost:8888/BTarc/wp-content/uploads/2012/12/501.png"  />
                        </div>
                        
                        <div class="six columns hide-on-phones">
                        	<div class="ys">Young Scientist & Technology 50th Year Exhibiton Archive</div> 
                        </div>
